...
#if !defined(CY_CAPSENSE_CSD_PVT_CapSense_2_H)
#define CY_CAPSENSE_CSD_PVT_CapSense_2_H
...
}CapSense_2_CONFIG_TYPE_POINTERS_P4_v2_40;
...
typedef struct
{
    ...
    CapSense_2_CONFIG_TYPE_POINTERS_P4_v2_40 const * pointers;
}CapSense_2_CONFIG_TYPE_P4_v2_40;

#define CapSense_2_AVG_SAMPLES_NUM        (1u)
...
#else
    #define CapSense_2_EnableScanSlot(slot)   CapSense_2_EnableSensor(slot)
    #define CapSense_2_DisableScanSlot(slot)  CapSense_2_DisableSensor(slot)
#endif  /* End CapSense_2_IS_COMPLEX_SCANSLOTS */
...
void CapSense_2_DisableBaselineIDAC(void);
void CapSense_2_EnableBaselineIDAC(const CapSense_2_CONFIG_TYPE_P4_v2_40 *config);

uint32 CapSense_2_GetLowCp(CapSense_2_CP_MEASURE_CONFIG *config);
uint32 CapSense_2_GetHighCp(const CapSense_2_CP_MEASURE_CONFIG *config);
uint32 CapSense_2_CalibrateIDAC(CapSense_2_CP_MEASURE_CONFIG *config);
uint16 CapSense_2_ScanSensorCp(const CapSense_2_CP_MEASURE_CONFIG *config);

void CapSense_2_ConnectElectrode(uint32 pinNumber, uint32 portNumber);
void CapSense_2_DisconnectElectrode(uint32 pinNumber, uint32 portNumber);
...
#endif /* CY_CAPSENSE_CSD_PVT_CapSense_2_H */
