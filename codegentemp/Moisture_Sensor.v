// ======================================================================
// Moisture_Sensor.v generated from TopDesign.cysch
// 12/12/2016 at 12:18
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=14, Polarity=1, Resolution=7, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense_1:IDAC2, CY_INSTANCE_SHORT_NAME=IDAC2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=CapSense_1_IDAC2, )
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=16, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense_1:IDAC1, CY_INSTANCE_SHORT_NAME=IDAC1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=CapSense_1_IDAC1, )
...
module CapSense_CSD_P4_v2_50_2 ;
	...
	cy_clock_v1_0
		#(.id("337b2c3c-372a-4a38-8e72-d6242d1a04b7/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("337b2c3c-372a-4a38-8e72-d6242d1a04b7/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("337b2c3c-372a-4a38-8e72-d6242d1a04b7/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
		  ...
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("Generic0_0__GEN,Generic1_0__GEN,Generic2_0__GEN,Generic3_0__GEN,Generic4_0__GEN,Generic5_0__GEN,Generic6_0__GEN,Generic7_0__GEN"),
		  .pin_mode("AAAAAAAA"),
		  .por_state(4),
		  .sio_group_cnt(0),
	...
	cy_clock_v1_0
		#(.id("337b2c3c-372a-4a38-8e72-d6242d1a04b7/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
...
module ADC_SAR_SEQ_P4_v2_40_4 (
	...
	cy_clock_v1_0
		#(.id("5d51ef31-a2fa-4dd9-8a82-f119a8f1324e/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
// DieTemp_P4_v1_0(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=DieTemp_P4_v1_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DieTemp_1, CY_INSTANCE_SHORT_NAME=DieTemp_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=DieTemp_1, )
module DieTemp_P4_v1_0_6 (
    temp);
    inout       temp;
    electrical  temp;
...
module top ;
    ...
    CapSense_CSD_P4_v2_50_2 CapSense_1 ();
	...
	wire [0:0] tmpOE__temp_humidity_pin_net;
	wire [0:0] tmpFB_0__temp_humidity_pin_net;
	wire [0:0] tmpINTERRUPT_0__temp_humidity_pin_net;
	electrical [0:0] tmpSIOVREF__temp_humidity_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		temp_humidity_pin
		 (.oe(tmpOE__temp_humidity_pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__temp_humidity_pin_net[0:0]}),
		  .io({Net_7123}),
		  .siovref(tmpSIOVREF__temp_humidity_pin_net),
		  .interrupt({tmpINTERRUPT_0__temp_humidity_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__temp_humidity_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v3_20_3 I2C_1 (
        .cts_in(1'b0),
        .tx_out(Net_7105),
        .rts_out(Net_7106),
        .interrupt(Net_7107),
	...
	wire [0:0] tmpOE__RS_485_Dir_net;
	wire [0:0] tmpFB_0__RS_485_Dir_net;
	wire [0:0] tmpIO_0__RS_485_Dir_net;
	wire [0:0] tmpINTERRUPT_0__RS_485_Dir_net;
	electrical [0:0] tmpSIOVREF__RS_485_Dir_net;

	cy_psoc3_pins_v1_10
		#(.id("7a38deb4-7119-41b6-adf0-fca372c32e4d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RS_485_Dir
		 (.oe(tmpOE__RS_485_Dir_net),
		  .y({Net_6982}),
		  .fb({tmpFB_0__RS_485_Dir_net[0:0]}),
		  .io({tmpIO_0__RS_485_Dir_net[0:0]}),
		  .siovref(tmpSIOVREF__RS_485_Dir_net),
		  .interrupt({tmpINTERRUPT_0__RS_485_Dir_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RS_485_Dir_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_SEQ_P4_v2_40_4 ADC_SAR_Seq_1 (
        .Vref(Net_6097),
        .sdone(Net_6098),
        .eoc(Net_6099),
        .aclk(1'b0),
	...
	wire [10:0] tmpOE__Pin_2_net;
	wire [10:0] tmpFB_10__Pin_2_net;
	wire [10:0] tmpIO_10__Pin_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2_net;
	electrical [0:0] tmpSIOVREF__Pin_2_net;

	cy_psoc3_pins_v1_10
		#(.id("9b78533d-acc3-42a4-aebb-6216f97a6304"),
		...
		Pin_2
		 (.oe(tmpOE__Pin_2_net),
		  .y({11'b0}),
		  .fb({tmpFB_10__Pin_2_net[10:0]}),
		  .analog({Net_7052, Net_7053, Net_7054, Net_7055, Net_7056, Net_7057, Net_7058, Net_7059, Net_7060, Net_7061, Net_7062}),
		  .io({tmpIO_10__Pin_2_net[10:0]}),
	...
	assign tmpOE__Pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{11'b11111111111} : {11'b11111111111};
    ...
    defparam AMux_2.muxin_width = 12;
    defparam AMux_2.init_mux_sel = 12'h0;
    defparam AMux_2.one_active = 1;
    defparam AMux_2.connect_mode = 1;
    
    // -- AMux AMux_2 end --

	wire [0:0] tmpOE__One_Wire_Pin_net;
	wire [0:0] tmpFB_0__One_Wire_Pin_net;
	wire [0:0] tmpINTERRUPT_0__One_Wire_Pin_net;
	electrical [0:0] tmpSIOVREF__One_Wire_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("c124c184-b2cd-45a4-81bf-d87390373a0c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		One_Wire_Pin
		 (.oe(tmpOE__One_Wire_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__One_Wire_Pin_net[0:0]}),
		  .io({Net_7125}),
		  .siovref(tmpSIOVREF__One_Wire_Pin_net),
		  .interrupt({tmpINTERRUPT_0__One_Wire_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__One_Wire_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_5 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_6985),
        .tx_interrupt(Net_6986),
        .rx_interrupt(Net_6987),
        .tx_data(Net_6988),
        .tx_clk(Net_6989),
        .rx_data(Net_6990),
        .rx_clk(Net_6991));
	...
	wire [0:0] tmpOE__Heart_Beat_Pin_net;
	wire [0:0] tmpFB_0__Heart_Beat_Pin_net;
	wire [0:0] tmpIO_0__Heart_Beat_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Heart_Beat_Pin_net;
	electrical [0:0] tmpSIOVREF__Heart_Beat_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Heart_Beat_Pin
		 (.oe(tmpOE__Heart_Beat_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Heart_Beat_Pin_net[0:0]}),
		  .io({tmpIO_0__Heart_Beat_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Heart_Beat_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Heart_Beat_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Heart_Beat_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Switch_Pin_net;
	wire [0:0] tmpFB_0__Switch_Pin_net;
	wire [0:0] tmpIO_0__Switch_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Switch_Pin_net;
	...
	cy_psoc3_pins_v1_10
		...
		Switch_Pin
		 (.oe(tmpOE__Switch_Pin_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Switch_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
    ...
    DieTemp_P4_v1_0_6 DieTemp_1 (
        .temp(Net_7021));

	wire [0:0] tmpOE__Source_Pin_net;
	wire [0:0] tmpFB_0__Source_Pin_net;
	wire [0:0] tmpIO_0__Source_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Source_Pin_net;
	electrical [0:0] tmpSIOVREF__Source_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("95994454-98ea-4d10-91a8-80c1eab64f89"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Source_Pin
		 (.oe(tmpOE__Source_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Source_Pin_net[0:0]}),
		  .io({tmpIO_0__Source_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Source_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Source_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Source_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Sink_Pin_net;
	wire [0:0] tmpFB_0__Sink_Pin_net;
	wire [0:0] tmpIO_0__Sink_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Sink_Pin_net;
	electrical [0:0] tmpSIOVREF__Sink_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("4394d0e1-a7d1-4dd6-94af-84778d2b3c6a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sink_Pin
		 (.oe(tmpOE__Sink_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sink_Pin_net[0:0]}),
		  .io({tmpIO_0__Sink_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Sink_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Sink_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sink_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Input_Pin_1_net;
	wire [0:0] tmpFB_0__Input_Pin_1_net;
	wire [0:0] tmpIO_0__Input_Pin_1_net;
	wire [0:0] tmpINTERRUPT_0__Input_Pin_1_net;
	electrical [0:0] tmpSIOVREF__Input_Pin_1_net;

	cy_psoc3_pins_v1_10
		#(.id("6016b655-cba2-4eb3-af74-b1449cf16c34"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Input_Pin_1
		 (.oe(tmpOE__Input_Pin_1_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Input_Pin_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpOE__input_Pin_2_net;
	wire [0:0] tmpFB_0__input_Pin_2_net;
	wire [0:0] tmpIO_0__input_Pin_2_net;
	wire [0:0] tmpINTERRUPT_0__input_Pin_2_net;
	electrical [0:0] tmpSIOVREF__input_Pin_2_net;

	cy_psoc3_pins_v1_10
		#(.id("a485f280-766e-420b-818c-2aef8c673f21"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		input_Pin_2
		 (.oe(tmpOE__input_Pin_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__input_Pin_2_net[0:0]}),
		  .io({tmpIO_0__input_Pin_2_net[0:0]}),
		  .siovref(tmpSIOVREF__input_Pin_2_net),
		  .interrupt({tmpINTERRUPT_0__input_Pin_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__input_Pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__input_Pin_3_net;
	wire [0:0] tmpFB_0__input_Pin_3_net;
	wire [0:0] tmpIO_0__input_Pin_3_net;
	wire [0:0] tmpINTERRUPT_0__input_Pin_3_net;
	electrical [0:0] tmpSIOVREF__input_Pin_3_net;

	cy_psoc3_pins_v1_10
		#(.id("a750af86-486c-4fa6-8be9-b0abeffd6cbc"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		input_Pin_3
		 (.oe(tmpOE__input_Pin_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__input_Pin_3_net[0:0]}),
		  .io({tmpIO_0__input_Pin_3_net[0:0]}),
		  .siovref(tmpSIOVREF__input_Pin_3_net),
		  .interrupt({tmpINTERRUPT_0__input_Pin_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__input_Pin_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
